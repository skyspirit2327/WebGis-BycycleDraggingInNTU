  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a data-toggle="tab" href="#layerlist" id="enterBtn" style='height:50px;line-height:50px;'>藍怪獸回報系統</a></li>
			<li class="btn">
	...
	<form>
		...
		<div class="form-group mb-3">
			  ...
			  <select class="form-control" id="day" name="day" >
				<option value="0">全部</option> 
				<option value="0">若要選擇請先選擇月份!</option> 
			  </select>
		</div>
				...
				<form action="./calculate.php" method="post">
					...
					<div class="form-group mb-3">
						  ...
						  <div class="input-group-prepend">
							<span class="input-group-text"  style='font-size:20px;font-weight:700;'>現在時間(XX:XX:XX; 24H)</span>
						  </div>
						  <input type="text" id="timeNow" class="form-control" placeholder="ex:  13:00:26" aria-label="Username" aria-describedby="basic-addon1">
						
					</div>
					<div class="form-group mb-3">
						
						  <div class="input-group-prepend">
							<span class="input-group-text"  style='font-size:20px;font-weight:700;'>預計離開時間(XX:XX:XX; 24H)</span>
						  </div>
						  <input type="text" id="goTime" class="form-control" placeholder="ex:  14:36:26" aria-label="Username" aria-describedby="basic-addon1">
...
<div class='modal ' id='dialog2' tabindex='-1' role='dialog' >
	<div class='modal-dialog modal-dialog-centered' role='document'>
		<div class='modal-content' style="background-color:rgb(250,214,137);">
			...
			<div class='modal-body'>
				<h1 align="center">你被拖吊的機率是：</hi>
				<h1 id="prob" align="center" style='color:red'></h1>
				<h6 align="center">*此機率僅供慘考，被拖吊一概不負責</h6>
			</div> 
			<div class='modal-footer'>
				<button type='button' class='btn btn-secondary' id='homeBtn' style='font-size:24px'>關閉</button>
...
<div class='modal ' id='dialog3' tabindex='-1' role='dialog' >
	<div class='modal-dialog modal-dialog-centered' role='document'>
		<div class='modal-content' style="background-color:rgb(250,214,137);">
			<div class='modal-header'>
				<h2 class='modal-title' style='font-family:微軟正黑體;color:rgb(0,137,108) ;'>藍怪獸回報系統</h2>
			...
			<div class='modal-body'>
				<form action="./calculate.php" method="post">
					...
					<div class="form-group mb-3">
						  ...
						  <div class="input-group-prepend">
							<span class="input-group-text"  style='font-size:20px;font-weight:700;'>日期(XXXX:XX:XX)</span>
						  </div>
						  <input type="text" id="timeNow" class="form-control" placeholder="ex:  2017:01:26" aria-label="Username" aria-describedby="basic-addon1">
						
					</div>
					<div class="form-group mb-3">
						
						  <div class="input-group-prepend">
							<span class="input-group-text"  style='font-size:20px;font-weight:700;'>時間(XX:XX:XX; 24H)</span>
						  </div>
						  <input type="text" id="goTime" class="form-control" placeholder="ex:  14:36:26" aria-label="Username" aria-describedby="basic-addon1">
			...
			<div class='modal-footer'>
				<button type='button' class='btn btn-secondary' id='cancelBtn3' style='font-size:24px'>取消</button>
				<input type='submit' class="btn btn-primary" style="font-size:24px" id="sendBtn" value='回報' >
			</div>
		</div>
		
	</div>
</div>
<div class='modal ' id='dialog4' tabindex='-1' role='dialog' >
	<div class='modal-dialog modal-dialog-centered' role='document'>
		<div class='modal-content' style="background-color:rgb(250,214,137);">
			<div class='modal-header'>
				<h2 class='modal-title' style='font-family:微軟正黑體;color:rgb(0,137,108) ;'>藍怪獸回報系統</h2>
			...
			<div class='modal-body'>
				<h1 align="center">資料已回報!</hi>
				<h6 align="center">祝福妳四年都不會被拖吊!</h6>
			</div> 
			<div class='modal-footer'>
				<button type='button' class='btn btn-secondary' id='homeBtn2' style='font-size:24px'>關閉</button>
