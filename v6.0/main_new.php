					...
					<div class="form-group mb-3">
						<div class="input-group mb-3">
						  <div class="input-group-prepend">
							<span class="input-group-text" id="timeNow" style='font-size:20px;font-weight:700;'>現在時間(XX:XX:XX; 24H)</span>
						  </div>
						  <input type="text" class="form-control" placeholder="ex:13:00:26" aria-label="Username" aria-describedby="basic-addon1">
						</div>
					</div>
					<div class="form-group mb-3">
						<div class="input-group mb-3">
						  <div class="input-group-prepend">
							<span class="input-group-text" id="goTime" style='font-size:20px;font-weight:700;'>預計離開時間(XX:XX:XX; 24H)</span>
						  </div>
						  <input type="text" class="form-control" placeholder="ex:14:36:26" aria-label="Username" aria-describedby="basic-addon1">
						</div>
					</div>						
				</form>
			</div>
